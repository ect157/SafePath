                  ...
                  ZStack{
                   VStack{
                    ZStack{
                     ...
                     Text(" \n Discover meaningful volunteering opportunities that empower and support survivors of human trafficking through the following links:\n")
                       .font(.title2)
                     .fontWeight(.bold)
                     .foregroundColor(Color("mainColor"))
                     .multilineTextAlignment(.center)
                  ...
                  ZStack{
                   VStack{
                    ZStack{
                     ...
                     Link("AIM", destination: URL(string: "https://aimfree.org/")!)
                       .font(.title3)
                       .fontWeight(.bold)
                            .buttonStyle(.borderedProminent)
                            .tint(Color("darkColor"))
